...
INSERT INTO actions (action, `file`, title, `right`, box, sub, id) VALUES('addNews', 'news.pl', 'Neue Nachricht', 0, 'news;navigation', 'addNews', 3);
...
INSERT INTO actions (`action`,`file`,title,`right`,box,sub,id) VALUES ('impressum', 'impressum.pl', 'Impressum', 0, 'impressum', 'main',51);
...
INSERT INTO box (`file`, position, `right`, name, id, dynamic) VALUES('navigation.pl', 'left', 0, 'Navigation', 1, 'right');
...
INSERT INTO box (`file`,position,`right`,name,dynamic,id) VALUES ('news.pl', 'disabled', 0, 'News', 'left',7);
